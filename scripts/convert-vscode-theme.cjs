...
/**
 * VS Code Theme to CodeCaptain Theme Converter
 * 
 * USAGE:
 ...
 *   2. Converts it to CodeCaptain theme format:
...
function convertVsCodeTheme(vscodeThemePath) {
  ...
  // Build CodeCaptain theme
  const codecaptainTheme = {
    metadata: {
