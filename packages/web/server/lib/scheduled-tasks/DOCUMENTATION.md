...
Server-owned scheduled task runtime and routes for CodeCaptain-only automation.
...
- This module is CodeCaptain feature logic; it is intentionally separate from CodeCaptain-core proxy/runtime internals.
...
- Registers:
  ...
  - `GET /api/codecaptain/scheduled-tasks/status`
  - `GET /api/codecaptain/events`
