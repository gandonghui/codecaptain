---
title: Reverse Proxy
description: Configure CodeCaptain correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run CodeCaptain behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
