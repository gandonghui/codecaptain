...
## Polecenie CodeCaptain kończy się lub nie uruchamia

- upewnij się, że Node.js `>=22`
- uruchom `codecaptain --version`
- w razie potrzeby zainstaluj ponownie najnowsze CLI

## Webowy interfejs jest nieosiągalny

- sprawdź logi serwera poleceniem `codecaptain logs`
...
- upewnij się, że serwer CodeCaptain działa
