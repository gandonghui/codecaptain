---
title: Voice Mode
description: Speak to CodeCaptain and hear replies read aloud.
---

# Voice Mode

Voice mode lets you dictate messages and have replies read back to you. Turn it on at **Settings → CodeCaptain → Voice**.
