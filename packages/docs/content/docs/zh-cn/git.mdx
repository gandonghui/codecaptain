...
description: 无需离开 CodeCaptain 即可暂存、提交和管理分支。
---

# Git 与 GitHub 工作流

CodeCaptain 内置了 git 视图，让你可以审阅变更、提交并管理分支，而无需切换到终端。从右侧边栏的 **Git** 标签页打开它。
...
然后编写提交信息并提交。你可以让 CodeCaptain 从你已暂存的变更中 **生成提交信息** — 它使用当前会话的模型，因此你需要打开一个会话。
...
如果一次合并、变基或集成遇到冲突，CodeCaptain 会显示卡住的内容并让你解决它 — 包括把它交给智能体。
