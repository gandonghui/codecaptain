...
## O comando CodeCaptain encerra ou não inicia

- confirme o Node.js `>=22`
- execute `codecaptain --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `codecaptain logs`
...
- confirme que o servidor do CodeCaptain está em execução
