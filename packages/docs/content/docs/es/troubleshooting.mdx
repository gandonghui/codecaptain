...
## El comando CodeCaptain se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `codecaptain --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `codecaptain logs`
...
- confirma que el servidor de CodeCaptain está en marcha
