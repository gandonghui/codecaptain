---
title: Quickstart
description: Start CodeCaptain quickly and pick the right app for the task.
---
...
1. Install [CodeCaptain-core](https://opencode.ai).
2. Install the CodeCaptain CLI (see [Install](/install/) for the one-line command).
...
You should see the CodeCaptain session list in your browser. If it loads, you're up and running.
