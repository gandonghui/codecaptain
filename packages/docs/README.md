# CodeCaptain Docs Source

This package is the source-of-truth for CodeCaptain public docs content.
...
Website rendering/deployment happens in `codecaptain-website` (`apps/docs`).
