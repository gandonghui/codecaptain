  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running CodeCaptain. Verify the address points to an CodeCaptain server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The CodeCaptain server at "${host || 'unknown'}" is not compatible with this app version. Update CodeCaptain on the server, then try again.`,
