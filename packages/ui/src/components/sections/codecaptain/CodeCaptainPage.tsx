...
import { CodeCaptainVisualSettings } from './CodeCaptainVisualSettings';
...
import type { CodeCaptainSection } from './types';
...
interface CodeCaptainPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: CodeCaptainSection;
}

export const CodeCaptainPage: React.FC<CodeCaptainPageProps> = ({ section }) => {
    ...
    if (!section) {
        return (
            <ScrollableOverlay
                ...
                className="w-full"
            >
                <div className="codecaptain-page-body mx-auto max-w-3xl space-y-3 p-3 sm:space-y-6 sm:p-6 sm:pt-8">
                    <CodeCaptainVisualSettings />
    ...
    return (
        <ScrollableOverlay
            ...
            className="w-full"
        >
            <div className="codecaptain-page-body mx-auto max-w-3xl space-y-6 p-3 sm:p-6 sm:pt-8">
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <CodeCaptainVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'pwaOrientation',
        'mobileKeyboardMode',
