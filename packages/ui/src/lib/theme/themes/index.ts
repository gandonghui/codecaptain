...
import codecaptainLightRaw from './fields-of-the-shire-light.json';
import codecaptainDarkRaw from './fields-of-the-shire-dark.json';
...
export const themes: Theme[] = [
  ...
  codecaptainDarkTheme,
  flexokiLightTheme,
  flexokiDarkTheme,
  ...presetThemes.filter(
    (theme) => theme.metadata.id !== 'codecaptain-light' && theme.metadata.id !== 'codecaptain-dark',
  ),
];
