...
import codecaptain_dark_Raw from './fields-of-the-shire-dark.json';
import codecaptain_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  codecaptain_dark_Raw as Theme,
  codecaptain_light_Raw as Theme,
