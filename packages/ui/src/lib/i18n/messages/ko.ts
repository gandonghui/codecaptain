...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 CodeCaptain를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'CodeCaptain가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutCodeCaptain': 'CodeCaptain 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 CodeCaptain에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'CodeCaptain 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'CodeCaptain 버전 {version}',
  'aboutDialog.openCodeVersionLabel': 'CodeCaptain-core 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'CodeCaptain 상태, CodeCaptain-core 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 CodeCaptain를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'CodeCaptain 메뉴',
  'header.actions.openAppMenuAria': 'CodeCaptain 메뉴 열기',
  ...
  'chat.emptyState.opencodeUnreachable': 'CodeCaptain-core에 연결할 수 없음',
  ...
  'openCodeStatusDialog.title': 'CodeCaptain-core 상태',
  'openCodeStatusDialog.description': '현재 CodeCaptain-core 상태와 진단 정보를 확인합니다.',
  ...
  'sessionAuth.locked.unlockTitle': 'CodeCaptain 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 CodeCaptain 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'CodeCaptain 멀티런 창.',
  ...
  'onboarding.chooser.title': 'CodeCaptain에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'CodeCaptain-core 설정',
  'onboarding.localSetup.description': '계속하려면 CodeCaptain-core CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'opencode 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'CodeCaptain-core CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 CodeCaptain-core를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'CodeCaptain가 CodeCaptain-core를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'CodeCaptain-core는 CodeCaptain의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'CodeCaptain-core 문서',
  'onboarding.localSetup.docs.default': 'CodeCaptain-core 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'CodeCaptain-core CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'CodeCaptain-core 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? CodeCaptain-core CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'CodeCaptain 설정에 저장하고 CodeCaptain-core 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 CodeCaptain-core를 네이티브로 설치하고 실행하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 CodeCaptain 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 CodeCaptain 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 CodeCaptain 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 CodeCaptain가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 CodeCaptain를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 CodeCaptain가 실행 중이 아닙니다. 주소가 CodeCaptain 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 CodeCaptain-core를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'CodeCaptain-core CLI를 시작할 수 없거나 설치되어 있지 않습니다. CodeCaptain-core를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 CodeCaptain가 실행 중이 아닙니다. 주소가 CodeCaptain 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 CodeCaptain 서버가 이 앱 버전과 호환되지 않습니다. 서버의 CodeCaptain를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'CodeCaptain 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'CodeCaptain 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `codecaptain update`를 실행하세요.',
  'opencodeUpdate.toast.available.title': 'CodeCaptain-core 업데이트',
  ...
  'opencodeUpdate.toast.actions.reload': 'CodeCaptain-core 다시 로드',
  'opencodeUpdate.toast.upgrading.title': 'CodeCaptain-core 업데이트 중...',
  'opencodeUpdate.toast.upgrading.description': 'CodeCaptain를 열어 두세요.',
  'opencodeUpdate.toast.updated.title': 'CodeCaptain-core 업데이트 완료',
  ...
  'opencodeUpdate.toast.failed.title': 'CodeCaptain-core를 업데이트할 수 없음',
  'opencodeUpdate.toast.failed.description': 'CodeCaptain-core 업그레이드에 실패했습니다.',
  'opencodeUpdate.toast.reload.message': 'CodeCaptain-core 다시 시작 중...',
  ...
  'openChamberLogo.aria.logo': 'CodeCaptain 로고',
