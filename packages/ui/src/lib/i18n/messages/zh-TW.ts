...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 CodeCaptain 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'CodeCaptain 已安裝',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 CodeCaptain。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 CodeCaptain，但與此應用程式版本不相容。請更新伺服器上的 CodeCaptain 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 CodeCaptain 伺服器與此應用程式版本不相容。請更新伺服器上的 CodeCaptain 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutCodeCaptain': '關於 CodeCaptain',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 CodeCaptain 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 CodeCaptain',
  ...
  'aboutDialog.openChamberVersionLabel': 'CodeCaptain 版本 {version}',
  'aboutDialog.openCodeVersionLabel': 'CodeCaptain-core 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 CodeCaptain 狀態、CodeCaptain-core 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 CodeCaptain',
  ...
  'header.actions.openAppMenu': 'CodeCaptain 選單',
  'header.actions.openAppMenuAria': '開啟 CodeCaptain 選單',
  ...
  'chat.emptyState.opencodeUnreachable': '無法連線 CodeCaptain-core',
  ...
  'openCodeStatusDialog.title': 'CodeCaptain-core 狀態',
  'openCodeStatusDialog.description': '查看目前 CodeCaptain-core 狀態與診斷資訊。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 CodeCaptain',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 CodeCaptain 伺服器之間切換',
  ...
  'multiRun.window.description': 'CodeCaptain 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 CodeCaptain',
  ...
  'onboarding.localSetup.title': '設定 CodeCaptain-core',
  'onboarding.localSetup.description': '安裝 CodeCaptain-core CLI 以繼續。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '選擇 CodeCaptain-core 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'CodeCaptain-core CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 CodeCaptain-core。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 CodeCaptain 未自動偵測到 CodeCaptain-core，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'CodeCaptain-core 是 CodeCaptain 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'CodeCaptain-core 文件',
  'onboarding.localSetup.docs.default': 'CodeCaptain-core 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 CodeCaptain-core CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 CodeCaptain-core',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 CodeCaptain-core CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 CodeCaptain 設定並重新載入 CodeCaptain-core 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 CodeCaptain-core。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 CodeCaptain 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 CodeCaptain 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 CodeCaptain。請確認位址是否指向 CodeCaptain 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 CodeCaptain-core 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'CodeCaptain-core CLI 無法啟動或未安裝。請安裝 CodeCaptain-core，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 CodeCaptain。請確認位址是否指向 CodeCaptain 伺服器。',
  ...
  'startup.initRecovery.description': 'CodeCaptain 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 CodeCaptain...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：codecaptain update',
  'opencodeUpdate.toast.available.title': 'CodeCaptain-core 更新',
  ...
  'opencodeUpdate.toast.actions.reload': '重新載入 CodeCaptain-core',
  'opencodeUpdate.toast.upgrading.title': '正在更新 CodeCaptain-core...',
  'opencodeUpdate.toast.upgrading.description': '請保持 CodeCaptain 開啟。',
  'opencodeUpdate.toast.updated.title': 'CodeCaptain-core 已更新',
  'opencodeUpdate.toast.updated.description': '更新已安裝。',
  'opencodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'opencodeUpdate.toast.failed.title': '無法更新 CodeCaptain-core',
  'opencodeUpdate.toast.failed.description': 'CodeCaptain-core 升級失敗。',
  'opencodeUpdate.toast.reload.message': '正在重新啟動 CodeCaptain-core...',
  ...
  'openChamberLogo.aria.logo': 'CodeCaptain 標誌',
