...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala CodeCaptain para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "CodeCaptain se instaló",
  ...
  "sessions.sidebar.footer.actions.aboutCodeCaptain": "Acerca de CodeCaptain",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a CodeCaptain: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener CodeCaptain",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de CodeCaptain {version}",
  "aboutDialog.openCodeVersionLabel": "Versión de CodeCaptain-core {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de CodeCaptain, el estado de CodeCaptain-core, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por CodeCaptain de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de CodeCaptain",
  "header.actions.openAppMenuAria": "Abrir menú de CodeCaptain",
  ...
  "chat.emptyState.opencodeUnreachable": "CodeCaptain-core no es accesible",
  ...
  "openCodeStatusDialog.title": "Estado de CodeCaptain-core",
  "openCodeStatusDialog.description": "Inspecciona el estado actual de CodeCaptain-core y diagnósticos.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear CodeCaptain",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de CodeCaptain",
  ...
  "multiRun.window.description": "Ventana de CodeCaptain Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a CodeCaptain",
  ...
  "onboarding.localSetup.title": "Configuración de CodeCaptain-core",
  "onboarding.localSetup.description": "Instala la CLI de CodeCaptain-core para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Seleccionar ejecutable de opencode",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de CodeCaptain-core aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala CodeCaptain-core con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si CodeCaptain no detecta CodeCaptain-core automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "CodeCaptain-core es el corazón de CodeCaptain. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de CodeCaptain-core",
  "onboarding.localSetup.docs.default": "Documentación de CodeCaptain-core",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de CodeCaptain-core está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando CodeCaptain-core",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de CodeCaptain-core:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de CodeCaptain y recarga la configuración de CodeCaptain-core.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta CodeCaptain-core de forma nativa.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de CodeCaptain para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor CodeCaptain o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de CodeCaptain. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta CodeCaptain pero no es compatible con esta versión de la app. Actualiza CodeCaptain en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando CodeCaptain. Verifica que la dirección apunte a un servidor CodeCaptain.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "CodeCaptain-core Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de CodeCaptain-core no pudo iniciarse o no está instalado. Instala CodeCaptain-core o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando CodeCaptain. Verifica que la dirección apunte a un servidor CodeCaptain.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor CodeCaptain en \"{host}\" no es compatible con esta versión de la app. Actualiza CodeCaptain en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "CodeCaptain no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando CodeCaptain...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: codecaptain update",
  "opencodeUpdate.toast.available.title": "Actualización de CodeCaptain-core",
  ...
  "opencodeUpdate.toast.actions.reload": "Recargar CodeCaptain-core",
  "opencodeUpdate.toast.upgrading.title": "Actualizando CodeCaptain-core...",
  "opencodeUpdate.toast.upgrading.description": "Mantén CodeCaptain abierto.",
  "opencodeUpdate.toast.updated.title": "CodeCaptain-core actualizado",
  ...
  "opencodeUpdate.toast.failed.title": "No se pudo actualizar CodeCaptain-core",
  "opencodeUpdate.toast.failed.description": "La actualización de CodeCaptain-core falló.",
  "opencodeUpdate.toast.reload.message": "Reiniciando CodeCaptain-core...",
  ...
  "openChamberLogo.aria.logo": "Logo de CodeCaptain",
