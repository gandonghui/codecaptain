...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install CodeCaptain for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'CodeCaptain installed',
  ...
  'sessions.sidebar.footer.actions.aboutCodeCaptain': 'About CodeCaptain',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to CodeCaptain — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop CodeCaptain',
  ...
  'aboutDialog.openChamberVersionLabel': 'CodeCaptain version {version}',
  'aboutDialog.openCodeVersionLabel': 'CodeCaptain-core version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes CodeCaptain state, CodeCaptain-core health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate CodeCaptain efficiently',
  ...
  'header.actions.openAppMenu': 'CodeCaptain menu',
  'header.actions.openAppMenuAria': 'Open CodeCaptain menu',
  ...
  'chat.emptyState.opencodeUnreachable': 'CodeCaptain-core is not reachable',
  ...
  'openCodeStatusDialog.title': 'CodeCaptain-core Status',
  'openCodeStatusDialog.description': 'Inspect current CodeCaptain-core status and diagnostics.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock CodeCaptain',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote CodeCaptain servers',
  ...
  'multiRun.window.description': 'CodeCaptain Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to CodeCaptain',
  ...
  'onboarding.localSetup.title': 'Setting Up CodeCaptain-core',
  'onboarding.localSetup.description': 'Install CodeCaptain-core CLI to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select opencode binary',
  'onboarding.localSetup.errors.cliNotReady': 'CodeCaptain-core CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install CodeCaptain-core with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If CodeCaptain does not detect CodeCaptain-core automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'CodeCaptain-core is the heart of CodeCaptain — install it to get started.',
  'onboarding.localSetup.docs.windows': 'CodeCaptain-core docs',
  'onboarding.localSetup.docs.default': 'CodeCaptain-core docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if CodeCaptain-core CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for CodeCaptain-core',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the CodeCaptain-core CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to CodeCaptain settings and reloads CodeCaptain-core configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run CodeCaptain-core natively.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an CodeCaptain server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an CodeCaptain server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different CodeCaptain version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running CodeCaptain but is not compatible with this app version. Update CodeCaptain on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running CodeCaptain. Verify the address points to an CodeCaptain server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local CodeCaptain-core Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'CodeCaptain-core CLI could not be started or is not installed. Install CodeCaptain-core or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running CodeCaptain. Verify the address points to an CodeCaptain server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The CodeCaptain server at "{host}" is not compatible with this app version. Update CodeCaptain on the server, then try again.',
  ...
  'startup.initRecovery.description': 'CodeCaptain could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating CodeCaptain...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: codecaptain update',
  'opencodeUpdate.toast.available.title': 'CodeCaptain-core update',
  ...
  'opencodeUpdate.toast.actions.reload': 'Reload CodeCaptain-core',
  'opencodeUpdate.toast.upgrading.title': 'Updating CodeCaptain-core...',
  'opencodeUpdate.toast.upgrading.description': 'Keep CodeCaptain open.',
  'opencodeUpdate.toast.updated.title': 'CodeCaptain-core updated',
  ...
  'opencodeUpdate.toast.failed.title': 'Could not update CodeCaptain-core',
  'opencodeUpdate.toast.failed.description': 'The CodeCaptain-core upgrade failed.',
  'opencodeUpdate.toast.reload.message': 'Restarting CodeCaptain-core...',
  ...
  'openChamberLogo.aria.logo': 'CodeCaptain logo',
