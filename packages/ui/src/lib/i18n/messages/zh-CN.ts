...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 CodeCaptain 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'CodeCaptain 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutCodeCaptain': '关于 CodeCaptain',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 CodeCaptain 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 CodeCaptain 状态、CodeCaptain-core 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 CodeCaptain',
  ...
  'header.actions.openAppMenu': 'CodeCaptain 菜单',
  'header.actions.openAppMenuAria': '打开 CodeCaptain 菜单',
  ...
  'chat.emptyState.opencodeUnreachable': '无法连接 CodeCaptain-core',
  ...
  'openCodeStatusDialog.title': 'CodeCaptain-core 状态',
  'openCodeStatusDialog.description': '查看当前 CodeCaptain-core 状态与诊断信息。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 CodeCaptain',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 CodeCaptain 服务器之间切换',
  ...
  'multiRun.window.description': 'CodeCaptain 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 CodeCaptain',
  ...
  'onboarding.localSetup.title': '设置 CodeCaptain-core',
  'onboarding.localSetup.description': '安装 CodeCaptain-core CLI 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 CodeCaptain-core 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'CodeCaptain-core CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 CodeCaptain-core。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 CodeCaptain 未自动检测到 CodeCaptain-core，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'CodeCaptain-core 是 CodeCaptain 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'CodeCaptain-core 文档',
  'onboarding.localSetup.docs.default': 'CodeCaptain-core 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 CodeCaptain-core CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 CodeCaptain-core',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 CodeCaptain-core CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 CodeCaptain 设置并重新加载 CodeCaptain-core 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 CodeCaptain-core。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 CodeCaptain 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 CodeCaptain 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 CodeCaptain。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 CodeCaptain，但与此应用版本不兼容。请更新服务器上的 CodeCaptain 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 CodeCaptain。请确认地址是否指向 CodeCaptain 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 CodeCaptain-core 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'CodeCaptain-core CLI 无法启动或未安装。请安装 CodeCaptain-core，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 CodeCaptain。请确认地址是否指向 CodeCaptain 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 CodeCaptain 服务器与此应用版本不兼容。请更新服务器上的 CodeCaptain 后重试。',
  ...
  'startup.initRecovery.description': 'CodeCaptain 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：codecaptain update',
  ...
  'opencodeUpdate.toast.actions.reload': '重载 CodeCaptain-core',
  'opencodeUpdate.toast.upgrading.title': '正在更新 CodeCaptain-core...',
  'opencodeUpdate.toast.upgrading.description': '请保持 CodeCaptain 打开。',
  ...
  'opencodeUpdate.toast.failed.title': '无法更新 CodeCaptain-core',
  'opencodeUpdate.toast.failed.description': 'CodeCaptain-core 升级失败。',
  'opencodeUpdate.toast.reload.message': '正在重启 CodeCaptain-core...',
  ...
  'openChamberLogo.aria.logo': 'CodeCaptain 标志',
