...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj CodeCaptain, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'CodeCaptain został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutCodeCaptain': 'O CodeCaptain',
  ...
  'chat.emptyState.opencodeUnreachable': 'CodeCaptain-core jest nieosiągalny',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia CodeCaptain.',
  ...
  'onboarding.chooser.title': 'Witaj w CodeCaptain',
  ...
  'onboarding.localSetup.title': 'Konfiguracja CodeCaptain-core',
  'onboarding.localSetup.description': 'Zainstaluj CLI CodeCaptain-core aby kontynuować.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę opencode',
  'onboarding.localSetup.errors.cliNotReady': 'CodeCaptain-core CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj CodeCaptain-core za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli CodeCaptain nie wykryje CodeCaptain-core automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja CodeCaptain-core',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy CodeCaptain-core CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki CodeCaptain-core:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień CodeCaptain i przeładowuje konfigurację CodeCaptain-core.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom CodeCaptain-core natywnie.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera CodeCaptain aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer CodeCaptain, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji CodeCaptain. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia CodeCaptain, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj CodeCaptain na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim CodeCaptain. Zweryfikuj czy adres wskazuje na serwer CodeCaptain.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'CodeCaptain-core lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić CodeCaptain-core CLI lub nie jest zainstalowany. Zainstaluj CodeCaptain-core lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia CodeCaptain. Zweryfikuj czy adres wskazuje na serwer CodeCaptain.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer CodeCaptain pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj CodeCaptain na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'CodeCaptain nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan CodeCaptain, kondycję CodeCaptain-core, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja CodeCaptain {version}',
  'aboutDialog.openCodeVersionLabel': 'Wersja CodeCaptain-core {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do CodeCaptain — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami CodeCaptain',
  ...
  'header.actions.openAppMenu': 'Menu CodeCaptain',
  'header.actions.openAppMenuAria': 'Otwórz menu CodeCaptain',
  ...
  'header.services.shutdownDev': 'Zatrzymaj CodeCaptain',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po CodeCaptain.',
  ...
  'openChamberLogo.aria.logo': 'Logo CodeCaptain',
  'openCodeStatusDialog.actions.copy': 'Kopiuj',
  'openCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę CodeCaptain-core.',
  'openCodeStatusDialog.empty.noData': 'Brak danych.',
  'openCodeStatusDialog.title': 'Status CodeCaptain-core',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj CodeCaptain',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: codecaptain update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie CodeCaptain...',
  ...
  'opencodeUpdate.toast.available.title': 'Aktualizacja CodeCaptain-core',
  ...
  'opencodeUpdate.toast.actions.reload': 'Przeładuj CodeCaptain-core',
  'opencodeUpdate.toast.upgrading.title': 'Aktualizowanie CodeCaptain-core...',
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw CodeCaptain otwarte.',
  'opencodeUpdate.toast.updated.title': 'CodeCaptain-core zaktualizowany',
  ...
  'opencodeUpdate.toast.failed.title': 'Nie udało się zaktualizować CodeCaptain-core',
  'opencodeUpdate.toast.failed.description': 'Aktualizacja CodeCaptain-core nie powiodła się.',
  'opencodeUpdate.toast.reload.message': 'Ponowne uruchamianie CodeCaptain-core...',
  ...
  'onboarding.localSetup.intro': 'CodeCaptain-core to serce CodeCaptain — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na CodeCaptain-core',
  ...
  'settings.codecaptain.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.codecaptain.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.codecaptain.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.codecaptain.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.codecaptain.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.codecaptain.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.codecaptain.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.codecaptain.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
