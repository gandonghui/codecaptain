export const settingsDict = {
  ...
  'settings.window.description': 'CodeCaptain settings window.',
  ...
  'settings.view.actions.reloadOpenCode': 'Reload CodeCaptain-core',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart CodeCaptain-core and reload its configuration.',
  ...
  'settings.codecaptain.tunnel.title': 'Remote Tunnel',
  'settings.codecaptain.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.codecaptain.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.codecaptain.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.codecaptain.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.codecaptain.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.codecaptain.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.codecaptain.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.codecaptain.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.codecaptain.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.codecaptain.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.codecaptain.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.codecaptain.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.codecaptain.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.codecaptain.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.codecaptain.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.codecaptain.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.codecaptain.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.codecaptain.tunnel.field.provider': 'Provider',
  'settings.codecaptain.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.codecaptain.tunnel.field.tunnelType': 'Tunnel type',
  'settings.codecaptain.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.codecaptain.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.codecaptain.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.codecaptain.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.codecaptain.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.codecaptain.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.codecaptain.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.codecaptain.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.codecaptain.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.codecaptain.tunnel.field.configurationFile': 'Configuration file',
  'settings.codecaptain.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.codecaptain.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.codecaptain.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.codecaptain.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.codecaptain.tunnel.field.connectLink': 'Connect link',
  'settings.codecaptain.tunnel.field.expires': 'Expires',
  'settings.codecaptain.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.codecaptain.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.codecaptain.tunnel.actions.saveToken': 'Save token',
  'settings.codecaptain.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.codecaptain.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.codecaptain.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.codecaptain.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.codecaptain.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.codecaptain.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.codecaptain.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.codecaptain.tunnel.actions.stopping': 'Stopping...',
  'settings.codecaptain.tunnel.actions.newConnectLink': 'New connect link',
  'settings.codecaptain.tunnel.actions.copied': 'Copied',
  'settings.codecaptain.tunnel.actions.retry': 'Retry',
  'settings.codecaptain.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.codecaptain.tunnel.option.mode.quick.label': 'Quick',
  'settings.codecaptain.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.codecaptain.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.codecaptain.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.codecaptain.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.codecaptain.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.codecaptain.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.codecaptain.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.codecaptain.tunnel.state.loading': 'Loading',
  'settings.codecaptain.tunnel.state.expired': 'Expired',
  'settings.codecaptain.tunnel.state.revoked': 'Revoked',
  'settings.codecaptain.tunnel.state.inactive': 'Inactive',
  'settings.codecaptain.tunnel.state.noExpiry': 'No expiry',
  'settings.codecaptain.tunnel.state.never': 'Never',
  'settings.codecaptain.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.codecaptain.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.codecaptain.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.codecaptain.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.codecaptain.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.codecaptain.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/codecaptain/cloudflare-managed-remote-tunnels.json.',
  'settings.codecaptain.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.codecaptain.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.codecaptain.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.codecaptain.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.codecaptain.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.codecaptain.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.codecaptain.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.codecaptain.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.codecaptain.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.codecaptain.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.codecaptain.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.codecaptain.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.codecaptain.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.codecaptain.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.codecaptain.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.codecaptain.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.codecaptain.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.codecaptain.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.codecaptain.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.codecaptain.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.codecaptain.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.codecaptain.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.codecaptain.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.codecaptain.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.codecaptain.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.codecaptain.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other CodeCaptain servers',
  'settings.remoteInstances.direct.description': 'Add another CodeCaptain server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another CodeCaptain server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid CodeCaptain connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so CodeCaptain Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether CodeCaptain should start the server for you, or connect to one that is already running.',
  ...
  'settings.codecaptain.about.title': 'About CodeCaptain',
  'settings.codecaptain.about.field.version': 'Version',
  'settings.codecaptain.about.field.openCodeVersion': 'CodeCaptain-core version',
  'settings.codecaptain.about.state.checking': 'Checking...',
  'settings.codecaptain.about.state.upToDate': 'Up to date',
  'settings.codecaptain.about.state.unknown': 'unknown',
  'settings.codecaptain.about.actions.checkUpdates': 'Check updates',
  'settings.codecaptain.about.actions.update': 'Update',
  'settings.codecaptain.about.actions.updateToVersion': 'Update to {version}',
  'settings.codecaptain.about.actions.checkForUpdates': 'Check for updates',
  'settings.codecaptain.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. CodeCaptain-core also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.skills.location.option.userOpencode.label': 'User / CodeCaptain-core',
  'settings.skills.location.option.userOpencode.description': 'Global CodeCaptain-core config location',
  'settings.skills.location.option.projectOpencode.label': 'Project / CodeCaptain-core',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. CodeCaptain will scan it for folders containing',
  ...
  'settings.codecaptain.passkeys.title': 'Passkeys',
  'settings.codecaptain.passkeys.field.currentDevice': 'Current device',
  'settings.codecaptain.passkeys.actions.add': 'Add passkey',
  'settings.codecaptain.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.codecaptain.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.codecaptain.passkeys.actions.signingOut': 'Signing out…',
  'settings.codecaptain.passkeys.actions.removing': 'Removing…',
  'settings.codecaptain.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.codecaptain.passkeys.state.loading': 'Loading passkeys…',
  'settings.codecaptain.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.codecaptain.passkeys.item.lastUsed': 'Last used {time}',
  'settings.codecaptain.passkeys.item.added': 'Added {time}',
  'settings.codecaptain.passkeys.time.neverUsed': 'Never used',
  'settings.codecaptain.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.codecaptain.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.codecaptain.passkeys.toast.added': 'Passkey added',
  'settings.codecaptain.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.codecaptain.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.codecaptain.passkeys.toast.removed': 'Passkey removed',
  'settings.codecaptain.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.codecaptain.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.codecaptain.sessionRetention.title': 'Session Retention',
  'settings.codecaptain.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.codecaptain.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.codecaptain.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.codecaptain.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.codecaptain.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.codecaptain.sessionRetention.field.days': 'days',
  'settings.codecaptain.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.codecaptain.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.codecaptain.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.codecaptain.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.codecaptain.sessionRetention.action.archive': 'Archive',
  'settings.codecaptain.sessionRetention.action.delete': 'Delete',
  'settings.codecaptain.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.codecaptain.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.codecaptain.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.codecaptain.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.codecaptain.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.codecaptain.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.codecaptain.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.codecaptain.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.codecaptain.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.codecaptain.desktopNetwork.title': 'Desktop Network Access',
  'settings.codecaptain.desktopNetwork.field.launchAtLoginAria': 'Start CodeCaptain at login',
  'settings.codecaptain.desktopNetwork.field.launchAtLogin': 'Start CodeCaptain when you log in',
  'settings.codecaptain.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.codecaptain.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.codecaptain.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.codecaptain.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.codecaptain.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.codecaptain.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.codecaptain.desktopPassword.field.password': 'Desktop UI Password',
  'settings.codecaptain.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.codecaptain.desktopPassword.field.passwordDescription': 'CodeCaptain asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.codecaptain.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.codecaptain.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.codecaptain.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.codecaptain.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.codecaptain.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.codecaptain.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.codecaptain.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.codecaptain.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.codecaptain.opencodeCli.title': 'CodeCaptain-core CLI',
  'settings.codecaptain.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.codecaptain.opencodeCli.tooltipSuffix': 'binary.',
  'settings.codecaptain.opencodeCli.field.binaryPath': 'CodeCaptain-core Binary Path',
  'settings.codecaptain.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.codecaptain.opencodeCli.field.showUpdateNotifications': 'Show CodeCaptain-core update notifications',
  'settings.codecaptain.opencodeCli.field.showUpdateNotificationsAria': 'Show CodeCaptain-core update notifications',
  'settings.codecaptain.opencodeCli.actions.browseAria': 'Browse for CodeCaptain-core binary path',
  'settings.codecaptain.opencodeCli.actions.browse': 'Browse',
  'settings.codecaptain.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.codecaptain.opencodeCli.actions.restartingOpenCode': 'Restarting CodeCaptain-core…',
  'settings.codecaptain.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.codecaptain.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.codecaptain.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.codecaptain.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.codecaptain.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.codecaptain.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.codecaptain.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.codecaptain.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.codecaptain.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.codecaptain.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.codecaptain.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.codecaptain.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.codecaptain.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.codecaptain.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.codecaptain.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.codecaptain.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.codecaptain.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.codecaptain.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.codecaptain.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.codecaptain.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.codecaptain.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.codecaptain.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.codecaptain.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.codecaptain.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.codecaptain.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.codecaptain.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.codecaptain.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.codecaptain.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.codecaptain.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.codecaptain.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.codecaptain.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.codecaptain.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.codecaptain.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.codecaptain.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.codecaptain.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open CodeCaptain there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'CodeCaptain on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how CodeCaptain should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote CodeCaptain server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote CodeCaptain UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How CodeCaptain should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingCodeCaptain': 'Installing CodeCaptain',
  'settings.remoteInstances.page.phase.updatingCodeCaptain': 'Updating CodeCaptain',
  ...
  'settings.codecaptain.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.codecaptain.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.codecaptain.worktrees.setup.title': 'Setup commands',
  'settings.codecaptain.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.codecaptain.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.codecaptain.worktrees.setup.loading': 'Loading...',
  'settings.codecaptain.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.codecaptain.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.codecaptain.worktrees.setup.addCommand': 'Add command',
  'settings.codecaptain.worktrees.list.title': 'Existing worktrees',
  'settings.codecaptain.worktrees.list.tooltip': 'Worktrees live outside the repo (CodeCaptain-core-managed). Deleting a worktree also removes linked sessions.',
  'settings.codecaptain.worktrees.list.loading': 'Loading worktrees...',
  'settings.codecaptain.worktrees.list.empty': 'No worktrees found for this project',
  'settings.codecaptain.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.codecaptain.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.sidebar.empty.description': 'Check your CodeCaptain-core configuration',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Check your CodeCaptain-core configuration',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to CodeCaptain-core and never stored by CodeCaptain.',
  ...
  'settings.providers.page.models.tokenBadge.output': 'out',
    'settings.providers.page.models.addCustomModelPlaceholder': 'e.g. hunyuan-pro, gpt-4',
  'settings.providers.page.models.actions.addCustomModel': 'Add Model',
'settings.providers.page.models.actions.hideModelFromSelectors': 'Hide model from selectors',
  ...
  'settings.mcp.page.status.description.connected': 'Connected and ready for CodeCaptain-core to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'CodeCaptain-core could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'Waiting for CodeCaptain-core to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use CodeCaptain-core\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let CodeCaptain-core infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'CodeCaptain-core will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but CodeCaptain-core reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but CodeCaptain-core reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. CodeCaptain-core reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. CodeCaptain-core reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but CodeCaptain-core reload failed',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'CodeCaptain-core reload failed after saving the browser callback URL',
  ...
  'settings.codecaptain.defaults.title': 'Session Defaults',
  'settings.codecaptain.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.codecaptain.defaults.summaryOpenCodeDefault': 'CodeCaptain-core agent default',
  'settings.codecaptain.defaults.field.defaultModel': 'Default Model',
  'settings.codecaptain.defaults.field.defaultThinking': 'Default Thinking',
  'settings.codecaptain.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.codecaptain.defaults.field.defaultAgent': 'Default Agent',
  'settings.codecaptain.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.codecaptain.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.codecaptain.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.codecaptain.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.codecaptain.defaults.option.default': 'Default',
  'settings.codecaptain.defaults.option.defaultLowercase': 'default',
  'settings.codecaptain.git.title': 'Git Preferences',
  'settings.codecaptain.git.changesViewTitle': 'Changes View',
  'settings.codecaptain.git.changesViewAria': 'Git changes view mode',
  'settings.codecaptain.git.option.flatList': 'Flat List',
  'settings.codecaptain.git.option.treeView': 'Tree View',
  'settings.codecaptain.git.optionAria': 'Git changes view mode: {option}',
  'settings.codecaptain.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.codecaptain.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.codecaptain.git.showGitignoredAria': 'Display gitignored files',
  'settings.codecaptain.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize CodeCaptain',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if CodeCaptain auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from CodeCaptain.',
  ...
  'settings.codecaptain.visual.section.colorMode': 'Color Mode',
  'settings.codecaptain.visual.section.mobileLayout': 'Mobile Layout',
  'settings.codecaptain.visual.option.mobileLayout.default': 'Old',
  'settings.codecaptain.visual.option.mobileLayout.new': 'New',
  'settings.codecaptain.visual.section.localization': 'Localization',
  'settings.codecaptain.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.codecaptain.visual.section.navigation': 'Navigation',
  'settings.codecaptain.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.codecaptain.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.codecaptain.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.codecaptain.visual.section.activityDefault': 'Activity Default',
  'settings.codecaptain.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.codecaptain.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.codecaptain.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.codecaptain.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.codecaptain.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.codecaptain.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.codecaptain.visual.section.diffLayout': 'Diff Layout',
  'settings.codecaptain.visual.section.diffLayoutAria': 'Diff layout',
  'settings.codecaptain.visual.section.privacy': 'Privacy',
  'settings.codecaptain.visual.field.lightTheme': 'Light Theme',
  'settings.codecaptain.visual.field.darkTheme': 'Dark Theme',
  'settings.codecaptain.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.codecaptain.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.codecaptain.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.codecaptain.visual.field.timeFormat': 'Time Format',
  'settings.codecaptain.visual.field.weekStartsOn': 'Week Starts On',
  'settings.codecaptain.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.codecaptain.visual.field.selectWeekStartAria': 'Select week start',
  'settings.codecaptain.visual.actions.reloadThemes': 'Reload themes',
  'settings.codecaptain.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.codecaptain.visual.field.macVibrancy': 'Window transparency',
  'settings.codecaptain.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.codecaptain.visual.actions.saveAndRestart': 'Save & restart',
  'settings.codecaptain.visual.actions.restarting': 'Restarting…',
  'settings.codecaptain.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.codecaptain.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/codecaptain/themes/',
  'settings.codecaptain.visual.field.installAppName': 'Install App Name',
  'settings.codecaptain.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.codecaptain.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.codecaptain.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.codecaptain.visual.field.installOrientation': 'Install Orientation',
  'settings.codecaptain.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.codecaptain.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.codecaptain.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.codecaptain.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.codecaptain.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.codecaptain.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.codecaptain.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.codecaptain.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.codecaptain.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.codecaptain.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.codecaptain.visual.field.interfaceFont': 'Interface Font',
  'settings.codecaptain.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.codecaptain.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.codecaptain.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.codecaptain.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.codecaptain.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.codecaptain.visual.field.codeFont': 'Code Font',
  'settings.codecaptain.visual.field.selectCodeFontAria': 'Select code font',
  'settings.codecaptain.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.codecaptain.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.codecaptain.visual.field.spacingDensity': 'Spacing Density',
  'settings.codecaptain.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.codecaptain.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.codecaptain.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.codecaptain.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.codecaptain.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.codecaptain.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.codecaptain.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.codecaptain.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.codecaptain.visual.option.fileEditorKeymap.default': 'Default',
  'settings.codecaptain.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.codecaptain.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.codecaptain.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.codecaptain.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.codecaptain.visual.field.bash': 'Bash',
  'settings.codecaptain.visual.field.editTools': 'Edit tools',
  'settings.codecaptain.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.codecaptain.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.codecaptain.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.codecaptain.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.codecaptain.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.codecaptain.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.codecaptain.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.codecaptain.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.codecaptain.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.codecaptain.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.codecaptain.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.codecaptain.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.codecaptain.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.codecaptain.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.codecaptain.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.codecaptain.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.codecaptain.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.codecaptain.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.codecaptain.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.codecaptain.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.codecaptain.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.codecaptain.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.codecaptain.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.codecaptain.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.codecaptain.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.codecaptain.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.codecaptain.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.codecaptain.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.codecaptain.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.codecaptain.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.codecaptain.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.codecaptain.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.codecaptain.visual.option.themeMode.system': 'System',
  'settings.codecaptain.visual.option.themeMode.light': 'Light',
  'settings.codecaptain.visual.option.themeMode.dark': 'Dark',
  'settings.codecaptain.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.codecaptain.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.codecaptain.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.codecaptain.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.codecaptain.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.codecaptain.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.codecaptain.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.codecaptain.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.codecaptain.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.codecaptain.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.codecaptain.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.codecaptain.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.codecaptain.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.codecaptain.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.codecaptain.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.codecaptain.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.codecaptain.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.codecaptain.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.codecaptain.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.codecaptain.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.codecaptain.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.codecaptain.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.codecaptain.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.codecaptain.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.codecaptain.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.codecaptain.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.codecaptain.visual.option.chatRenderMode.live.label': 'Live',
  'settings.codecaptain.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.codecaptain.visual.option.messageTransport.auto.label': 'Auto',
  'settings.codecaptain.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.codecaptain.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.codecaptain.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.codecaptain.visual.option.messageTransport.sse.label': 'SSE',
  'settings.codecaptain.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.codecaptain.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.codecaptain.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.codecaptain.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.codecaptain.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.codecaptain.visual.option.timeFormat.auto.label': 'Auto',
  'settings.codecaptain.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.codecaptain.visual.option.timeFormat.24h.label': '24-hour',
  'settings.codecaptain.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.codecaptain.visual.option.timeFormat.12h.label': '12-hour',
  'settings.codecaptain.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.codecaptain.visual.option.weekStart.auto.label': 'Auto',
  'settings.codecaptain.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.codecaptain.visual.option.weekStart.monday.label': 'Monday',
  'settings.codecaptain.visual.option.weekStart.sunday.label': 'Sunday',
