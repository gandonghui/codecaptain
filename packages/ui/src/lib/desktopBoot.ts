 ...
 * it as `window.__CODECAPTAIN_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __CODECAPTAIN_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__CODECAPTAIN_DESKTOP_BOOT_OUTCOME__;
