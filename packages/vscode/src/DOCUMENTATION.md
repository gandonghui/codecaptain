...
- `bridge-config-runtime.ts`
  ...
  - Includes CodeCaptain-core resolution diagnostics parity handler used by shared UI (`/api/config/opencode-resolution`).

- `bridge-settings-runtime.ts`
  - Settings read/write and CodeCaptain-core skills discovery via API for bridge consumers.
