...
description: Use when creating or modifying CodeCaptain UI text, labels, buttons, placeholders, aria labels, empty states, toasts, dialogs, settings copy, navigation labels, or any user-facing strings.
---
...
'chat.input.placeholder': 'Ask CodeCaptain...'
```
...
'Language': 'Language'
'chatLabel': 'Chat'
'askCodeCaptainDotDotDot': 'Ask CodeCaptain...'
```
...
- Product names: `CodeCaptain`, `CodeCaptain-core`, `GitHub`
